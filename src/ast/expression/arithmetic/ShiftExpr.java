...
public final class ShiftExpr extends ArithmeticBinExpr {

    public ShiftExpr(@NotNull Expr le, @NotNull Expr re) {
        super(le, re);
    }
    ...
    public @NotNull Value eval(@NotNull ValEnv env) throws RuntimeError {
        ...
        if(rv.implOfLess(IntegerValue.ZERO).toBoolean()){
            throw RuntimeError.SHIFT_ERROR;
        }
        return lv.implOfShift(rv);
    }
}
