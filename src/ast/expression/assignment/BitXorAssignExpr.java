...
public final class BitXorAssignExpr extends AssignBaseExpr {
    public BitXorAssignExpr(@NotNull Expr le, @NotNull Expr re) {
        super(le, re);
    }
    ...
    public @NotNull Value eval(@NotNull ValEnv env) throws RuntimeError {
        ...
        return rv.implOfAssign(env, ((IntegerValue) rv.deref()).implOfBitXor(v));
    }
}
