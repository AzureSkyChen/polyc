...
public final class DivAssignExpr extends AssignBaseExpr {
    public DivAssignExpr(@NotNull Expr le, @NotNull Expr re) {
        super(le, re);
    }
    ...
    public @NotNull Value eval(@NotNull ValEnv env) throws RuntimeError {
        ...
        return rv.implOfAssign(env, ((IntegerValue) rv.deref()).implOfDiv(v));
    }
}
