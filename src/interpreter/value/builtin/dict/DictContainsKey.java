...
public final class DictContainsKey extends Value implements Callable {

    private final @NotNull DictValue Self;

    public DictContainsKey(@NotNull DictValue self) {
        Self = self;
    }

    @Override
    public @NotNull BooleanValue implOfApply(@NotNull Value @NotNull [] valParams) throws RuntimeError {
        return Self.implOfContainsKey(valParams[0]);
    }
}
